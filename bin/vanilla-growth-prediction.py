...
def prepare_data(df):
    # Features will be: WeekNo, Temperature, Humidity, LightLevel, Year, and initial measurements
...
def visualize_growth(df):
    ...
    plt.subplot(2, 1, 1)
    plt.plot(df['WeekNo'], df['Vine1_Length(m)'], label='Vine 1')
    plt.plot(df['WeekNo'], df['Vine2_Length(m)'], label='Vine 2')
    plt.plot(df['WeekNo'], df['Vine3_Length(m)'], label='Vine 3')
    plt.plot(df['WeekNo'], df['Vine4_Length(m)'], label='Vine 4')
    ...
    plt.subplot(2, 1, 2)
    plt.plot(df['WeekNo'], df['Vine1_Leaves'], label='Vine 1')
    plt.plot(df['WeekNo'], df['Vine2_Leaves'], label='Vine 2')
    plt.plot(df['WeekNo'], df['Vine3_Leaves'], label='Vine 3')
    plt.plot(df['WeekNo'], df['Vine4_Leaves'], label='Vine 4')
    plt.xlabel('Week Number')
